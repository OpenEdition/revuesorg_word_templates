...
Source: "{#SrcModelesDir}\*.dot"; DestDir: "{userappdata}\Microsoft\Modèles"; Flags: ignoreversion overwritereadonly; Tasks: word2003
Source: "{#SrcMacrosDir}\*.dot"; DestDir: "{userappdata}\Microsoft\Modèles"; Flags: ignoreversion overwritereadonly; Tasks: word2003
Source: "{#SrcStartupDir}\*.dot"; DestDir: "{userappdata}\Microsoft\Word\DÉMARRAGE"; Flags: ignoreversion overwritereadonly; Tasks: word2003
